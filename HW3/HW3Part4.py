...
print "No, but this may not be the appropriate model.  Controlling for everything simultaneously may mask the result."

# Part f
results3.params['tradeshare'] * .5
results5.params['tradeshare'] * 0.5 + results5.params['tradeSquared'] * (0.5**2) + results5.params['tradeCubed'] * (0.5**3)
